...
### modprobed.db
if you have modprobed.db installed from SBo before few days... you dont have to plugin anything, all logs  every module ever probed on the target system 
is in a text‐based database... personally I run modprobed.db as user first time to create the conf file in my $HOME and then I ln -s this file to root /home. Because I build-install kernels from scripts as root... 
